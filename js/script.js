(function() {
  const rawData = [
    ...
    { municipio: 'Redenção', mes: 'Agosto', data: '05/08/2026', participantes: 'Comandante Henrique', agentes: 15, alunos: 0, professores: 0, escolas: 0, situacao: 'Implantado', proxima: 'Acompanhamento da implantação', tipo_orgao: 'Departamento' }
  ];
